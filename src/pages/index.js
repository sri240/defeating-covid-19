...
const IndexPage = () => (
  <Layout>
    ...
    <p>Sitting at home, one might stumble upon the convenient notion of helplessness, taking no notice of the potential for change in each and every one of us. During this time, positivity is a treasure, and being able to share our stories can unite us to defeat COVID-19, together.</p></div>
    <div class="help">
      <div class="p">
      ...
      <div class="donate">
        ...
        <div class="dopp"><a href="https://donate.worldvision.org/give/coronavirus-emergency-response?campaign=400042858&ds_rl=1280798&ds_rl=1280963&ds_rl=1280963&gclid=Cj0KCQjwu8r4BRCzARIsAA21i_BhMrrslytswvAoRBKusm0Z2UsCNtfrWhcFgEvemXHhBKzo5NOtqosaAq4CEALw_wcB&gclsrc=aw.ds" rel="noreferrer noopener" target="_blank">
          <h1 class="opp">World Vision</h1>
          <p>Donate to Coronavirus Emergency Response</p>
          </a>
        </div>
        <div class="dopp">
          <a href="https://www.who.int/emergencies/diseases/novel-coronavirus-2019/donate" rel="noreferrer noopener" target="_blank">
          <h1 class="opp">WHO</h1>
    ...
    <div class="stories" style={{marginBottom:"30px", paddingBottom:"10px"}}>
      ...
      <br></br>
      <div class="person"><p>As a senior graduating high school, going off to college, and just beginning to understand life, COVID has been surprisingly difficult, 
        yet interesting to live through. While I found it hard to keep up with the sudden barrage of assignments during lockdown, it was primarily due to the lack of 
        focus I had (because come on, you're at home all the time, you're not going to do schoolwork for eight hours a day). Yet that lack of focus brought along new 
      ...
      <br></br>
      <div class="person"><p>What I’ve been up to: Nothing much. Just waiting around for college to start, while grinding chemistry. In my free time, I grind valorant trying to climb to Platinum. I also recently started doing more cyber security things like CTF.</p>
      <h1 class="t">&nbsp; kevin z, california</h1>
      </div>

      <br></br>
      <div class="person"><p>I've been ok, though I'm definitely not getting enough sleep. I've just been at home doing review and going on walks occasionally, taking pictures and then spending way too much time photoshopping lol.</p>
      <h1 class="t">&nbsp; jenny, usa</h1>
      </div>

      <br></br>
      <div class="person"><p>I haven't been doing anything too fun, but I found an internship program that I got through a connection, and that's honestly all I've been doing aside from working out.</p>
      <h1 class="t">&nbsp; salah, earth</h1>
      </div>
      
      <br></br>
      <div class="person"><p>I've been doing great! I spend my time playing Minecraft and making brownies for myself and my little sister, even though it has actually gotten me injured, haha.</p>
      <h1 class="t">&nbsp; daddyadi101, earth</h1>
      </div>

      <br></br>
      <div class="person"><p>I've been doing fine, I've been learning tricks on my rollerblades and I've been writing (Well, staring at a blank screen and calling it writing).</p>
      <h1 class="t">&nbsp; cara, bay area</h1>
      </div>

      <br></br>
      <div class="person"><p>Mostly working out and playing video games, have been connecting with friends on discord though.</p>
      <h1 class="t">&nbsp; cheezyBread, bay area</h1>
      </div>

      <br></br>
      <div class="person"><p>I got an internship! It’s been tough, but I’m very grateful that I got this opportunity ^-^</p>
      <h1 class="t">&nbsp; jade, usa</h1>
      </div>

      <br></br>
      <div class="person"><p>I've been doing fine, mostly staying inside and playing games.</p>
